...
import resume from '../Header Section/Khushbu Yadav Resume New.pdf';
...
export default function Nav() {
  ...
  return (
    <>
      <nav
        style={{ backgroundColor: 'var(--bg-clr)', backdropFilter: 'blur(10px)' }}
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              ...
              >
                <Link to="/" className="text-white font-serif font-extrabold">
                  <img className="h-14 w-auto" src={kw} alt="Khushi" />
                </Link>
              </div>
