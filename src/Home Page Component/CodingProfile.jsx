          ...
          <Slider {...settings}>
            {data.map((d, index) => (
              <div
                ...
                className="w-full shadow-lg hover:shadow-full hover:shadow-blue-700 max-w-xs  p-6 bg-opacity-20 border border-gray-200 rounded-lg  dark:bg-gray-800 dark:border-gray-700"
              >
                <img
                ...
                <h5
                  ...
                  className="pt-4 mb-2 text-xl font-semibold tracking-tight text-white dark:text-white"
                >
                  {d.heading}
                </h5>
                <a
...
const data = [
  {
    ...
    link: "https://leetcode.com/khushbu_In/",
  },
  {
    ...
    link: "https://auth.geeksforgeeks.org/user/khushbuk2ni",
  },
  {
    heading: "CodeChef",
    ...
    link: "https://www.codechef.com/users/khushbuyad123",
  },
];
