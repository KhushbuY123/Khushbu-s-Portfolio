      ...
      <div className=" m-8 ">
        ...
        <div className="p-20 " data-aos="fade-in">
          <ol className="relative border-s border-gray-200 dark:border-gray-700  ">
            {data.map((d, idx) => (
              <li key={d.year + d.clg + idx} className="mb-10 ms-6 ">
                ...
                <div className="p-4 ml-4 hover:shadow-md hover:shadow-blue-700 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-700 dark:border-gray-600">
