...
import kw from "../Home Page Component/Header Section/logo1.png";
import resume from "../Home Page Component/Header Section/Khushbu Yadav Resume.pdf";
...
export default function Nav() {
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto max-w-8xl px-2 sm:px-6 lg:px-32">
          <div className="relative flex items-center justify-between">
            ...
            <div className="flex justify-center items-center">
              <div>
                <Link to="/">
                  <img className="h-24  w-24" src={kw} alt="Khushi" />
                </Link>
              </div>
